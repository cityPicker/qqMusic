        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-right" @click="toggleFavorite(currentSong)">
              <i class="icon" :class="iconFavorite(currentSong)"></i>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    _getPosAndScale () {
      ...
      const x = -(window.innerWidth / 2 - width / 2 - paddingLeft)
      const y = window.innerHeight - paddingTop - paddingBottom - width
